   ...
   0000                     471 	.ds 8
                    ...
                    FC00    671 _EP8FIFOBUF	=	0xfc00
                            ...
                            684 	.area CSEG    (CODE)
                            685 ;--------------------------------------------------------
                            686 ; global & static initialisations
                            687 ;--------------------------------------------------------
                            688 	.area HOME    (CODE)
                            ...
                            700 	.area CSEG    (CODE)
                            701 ;------------------------------------------------------------
                            702 ;Allocation info for local variables in function 'init_usrp'
                            703 ;------------------------------------------------------------
                            704 ;------------------------------------------------------------
                            705 ;	../common/usrp_common.c:30: init_usrp (void)
                            706 ;	-----------------------------------------
                            707 ;	 function init_usrp
                            708 ;	-----------------------------------------
   052C                     709 _init_usrp:
                    0002    710 	ar2 = 0x02
                    0003    711 	ar3 = 0x03
                    ...
                    0000    716 	ar0 = 0x00
                    0001    717 	ar1 = 0x01
                            718 ;	../common/usrp_common.c:32: CPUCS = bmCLKSPD1;	// CPU runs @ 48 MHz
                            719 ;	genAssign
   052C 90 E6 00            720 	mov	dptr,#_CPUCS
   052F 74 10               721 	mov	a,#0x10
   0531 F0                  722 	movx	@dptr,a
                            723 ;	../common/usrp_common.c:33: CKCON = 0;		// MOVX takes 2 cycles
                            724 ;	genAssign
   0532 75 8E 00            725 	mov	_CKCON,#0x00
                            726 ;	../common/usrp_common.c:37: IFCONFIG = bmIFCLKSRC | bm3048MHZ | bmIFCLKOE | bmIFCLKPOL | bmIFGPIF;
                            727 ;	genAssign
   0535 90 E6 01            728 	mov	dptr,#_IFCONFIG
   0538 74 F2               729 	mov	a,#0xF2
   053A F0                  730 	movx	@dptr,a
                            731 ;	../common/usrp_common.c:38: SYNCDELAY;
                            732 ;	genInline
   053B 00                  733 	 nop; nop; nop; 
                            734 ;	../common/usrp_common.c:42: IOA = bmPORT_A_INITIAL;	// Port A initial state
                            735 ;	genAssign
   053C 75 80 38            736 	mov	_IOA,#0x38
                            737 ;	../common/usrp_common.c:43: OEA = bmPORT_A_OUTPUTS;	// Port A direction register
                            738 ;	genAssign
   053F 75 B2 3B            739 	mov	_OEA,#0x3B
                            740 ;	../common/usrp_common.c:45: IOC = bmPORT_C_INITIAL;	// Port C initial state
                            741 ;	genAssign
   0542 75 A0 C0            742 	mov	_IOC,#0xC0
                            743 ;	../common/usrp_common.c:46: OEC = bmPORT_C_OUTPUTS;	// Port C direction register
                            744 ;	genAssign
   0545 75 B4 CF            745 	mov	_OEC,#0xCF
                            746 ;	../common/usrp_common.c:48: IOE = bmPORT_E_INITIAL;	// Port E initial state
                            747 ;	genAssign
   0548 75 B1 F0            748 	mov	_IOE,#0xF0
                            749 ;	../common/usrp_common.c:49: OEE = bmPORT_E_OUTPUTS;	// Port E direction register
                            750 ;	genAssign
   054B 75 B6 F8            751 	mov	_OEE,#0xF8
                            752 ;	../common/usrp_common.c:57: EP1OUTCFG = bmVALID | bmBULK;				SYNCDELAY;
                            753 ;	genAssign
   054E 90 E6 10            754 	mov	dptr,#_EP1OUTCFG
   0551 74 A0               755 	mov	a,#0xA0
   0553 F0                  756 	movx	@dptr,a
                            757 ;	genInline
   0554 00                  758 	 nop; nop; nop; 
                            759 ;	../common/usrp_common.c:58: EP1INCFG  = bmVALID | bmBULK | bmIN;			SYNCDELAY;
                            760 ;	genAssign
   0555 90 E6 11            761 	mov	dptr,#_EP1INCFG
   0558 74 E0               762 	mov	a,#0xE0
   055A F0                  763 	movx	@dptr,a
                            764 ;	genInline
   055B 00                  765 	 nop; nop; nop; 
                            766 ;	../common/usrp_common.c:60: EP2CFG    = bmVALID | bmBULK | bmQUADBUF;		SYNCDELAY;	// 512 quad bulk OUT
                            767 ;	genAssign
   055C 90 E6 12            768 	mov	dptr,#_EP2CFG
   055F 74 A0               769 	mov	a,#0xA0
   0561 F0                  770 	movx	@dptr,a
                            771 ;	genInline
   0562 00                  772 	 nop; nop; nop; 
                            773 ;	../common/usrp_common.c:61: EP4CFG    = 0;					SYNCDELAY;	// disabled
                            774 ;	genAssign
   0563 90 E6 13            775 	mov	dptr,#_EP4CFG
                            776 ;	Peephole 181	changed mov to clr
   0566 E4                  777 	clr	a
   0567 F0                  778 	movx	@dptr,a
                            779 ;	genInline
   0568 00                  780 	 nop; nop; nop; 
                            781 ;	../common/usrp_common.c:62: EP6CFG    = bmVALID | bmBULK | bmQUADBUF | bmIN;	SYNCDELAY;	// 512 quad bulk IN
                            782 ;	genAssign
   0569 90 E6 14            783 	mov	dptr,#_EP6CFG
   056C 74 E0               784 	mov	a,#0xE0
   056E F0                  785 	movx	@dptr,a
                            786 ;	genInline
   056F 00                  787 	 nop; nop; nop; 
                            788 ;	../common/usrp_common.c:63: EP8CFG    = 0;					SYNCDELAY;	// disabled
                            789 ;	genAssign
   0570 90 E6 15            790 	mov	dptr,#_EP8CFG
                            791 ;	Peephole 181	changed mov to clr
   0573 E4                  792 	clr	a
   0574 F0                  793 	movx	@dptr,a
                            794 ;	genInline
   0575 00                  795 	 nop; nop; nop; 
                            796 ;	../common/usrp_common.c:67: FIFORESET = bmNAKALL;					SYNCDELAY;
                            797 ;	genAssign
   0576 90 E6 04            798 	mov	dptr,#_FIFORESET
   0579 74 80               799 	mov	a,#0x80
   057B F0                  800 	movx	@dptr,a
                            801 ;	genInline
   057C 00                  802 	 nop; nop; nop; 
                            803 ;	../common/usrp_common.c:68: FIFORESET = 2;					SYNCDELAY;
                            804 ;	genAssign
   057D 90 E6 04            805 	mov	dptr,#_FIFORESET
   0580 74 02               806 	mov	a,#0x02
   0582 F0                  807 	movx	@dptr,a
                            808 ;	genInline
   0583 00                  809 	 nop; nop; nop; 
                            810 ;	../common/usrp_common.c:70: FIFORESET = 6;					SYNCDELAY;
                            811 ;	genAssign
   0584 90 E6 04            812 	mov	dptr,#_FIFORESET
   0587 74 06               813 	mov	a,#0x06
   0589 F0                  814 	movx	@dptr,a
                            815 ;	genInline
   058A 00                  816 	 nop; nop; nop; 
                            817 ;	../common/usrp_common.c:72: FIFORESET = 0;					SYNCDELAY;
                            818 ;	genAssign
   058B 90 E6 04            819 	mov	dptr,#_FIFORESET
                            820 ;	Peephole 181	changed mov to clr
   058E E4                  821 	clr	a
   058F F0                  822 	movx	@dptr,a
                            823 ;	genInline
   0590 00                  824 	 nop; nop; nop; 
                            825 ;	../common/usrp_common.c:78: EP2FIFOCFG =             bmWORDWIDE;			SYNCDELAY;
                            826 ;	genAssign
   0591 90 E6 18            827 	mov	dptr,#_EP2FIFOCFG
   0594 74 01               828 	mov	a,#0x01
   0596 F0                  829 	movx	@dptr,a
                            830 ;	genInline
   0597 00                  831 	 nop; nop; nop; 
                            832 ;	../common/usrp_common.c:79: EP2FIFOCFG = bmAUTOOUT | bmWORDWIDE;			SYNCDELAY;
                            833 ;	genAssign
   0598 90 E6 18            834 	mov	dptr,#_EP2FIFOCFG
   059B 74 11               835 	mov	a,#0x11
   059D F0                  836 	movx	@dptr,a
                            837 ;	genInline
   059E 00                  838 	 nop; nop; nop; 
                            839 ;	../common/usrp_common.c:80: EP6FIFOCFG = bmAUTOIN  | bmWORDWIDE;			SYNCDELAY;
                            840 ;	genAssign
   059F 90 E6 1A            841 	mov	dptr,#_EP6FIFOCFG
   05A2 74 09               842 	mov	a,#0x09
   05A4 F0                  843 	movx	@dptr,a
                            844 ;	genInline
   05A5 00                  845 	 nop; nop; nop; 
                            846 ;	../common/usrp_common.c:92: EP0BCH = 0;			SYNCDELAY;
                            847 ;	genAssign
   05A6 90 E6 8A            848 	mov	dptr,#_EP0BCH
                            849 ;	Peephole 181	changed mov to clr
   05A9 E4                  850 	clr	a
   05AA F0                  851 	movx	@dptr,a
                            852 ;	genInline
   05AB 00                  853 	 nop; nop; nop; 
                            854 ;	../common/usrp_common.c:96: EP1OUTBC = 0;			SYNCDELAY;
                            855 ;	genAssign
   05AC 90 E6 8D            856 	mov	dptr,#_EP1OUTBC
                            857 ;	Peephole 181	changed mov to clr
   05AF E4                  858 	clr	a
   05B0 F0                  859 	movx	@dptr,a
                            860 ;	genInline
   05B1 00                  861 	 nop; nop; nop; 
                            862 ;	../common/usrp_common.c:98: EP2GPIFFLGSEL = 0x01;		SYNCDELAY; // For EP2OUT, GPIF uses EF flag
                            863 ;	genAssign
   05B2 90 E6 D2            864 	mov	dptr,#_EP2GPIFFLGSEL
   05B5 74 01               865 	mov	a,#0x01
   05B7 F0                  866 	movx	@dptr,a
                            867 ;	genInline
   05B8 00                  868 	 nop; nop; nop; 
                            869 ;	../common/usrp_common.c:99: EP6GPIFFLGSEL = 0x02;		SYNCDELAY; // For EP6IN,  GPIF uses FF flag
                            870 ;	genAssign
   05B9 90 E6 E2            871 	mov	dptr,#_EP6GPIFFLGSEL
   05BC 74 02               872 	mov	a,#0x02
   05BE F0                  873 	movx	@dptr,a
                            874 ;	genInline
   05BF 00                  875 	 nop; nop; nop; 
                            876 ;	../common/usrp_common.c:104: EP6AUTOINLENH = (512) >> 8;	SYNCDELAY;  // this is the length for high speed
                            877 ;	genAssign
   05C0 90 E6 24            878 	mov	dptr,#_EP6AUTOINLENH
   05C3 74 02               879 	mov	a,#0x02
   05C5 F0                  880 	movx	@dptr,a
                            881 ;	genInline
   05C6 00                  882 	 nop; nop; nop; 
                            883 ;	../common/usrp_common.c:105: EP6AUTOINLENL = (512) & 0xff; SYNCDELAY;
                            884 ;	genAssign
   05C7 90 E6 25            885 	mov	dptr,#_EP6AUTOINLENL
                            886 ;	Peephole 181	changed mov to clr
   05CA E4                  887 	clr	a
   05CB F0                  888 	movx	@dptr,a
                            889 ;	genInline
   05CC 00                  890 	 nop; nop; nop; 
                            891 ;	../common/usrp_common.c:107: init_board ();
                            892 ;	genCall
                            893 ;	Peephole 253.b	replaced lcall/ret with ljmp
   05CD 02 06 63            894 	ljmp	_init_board
                            895 ;
                            896 	.area CSEG    (CODE)
                            897 	.area CONST   (CODE)
