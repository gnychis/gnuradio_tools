   ...
   0000                     471 	.ds 8
                    ...
                    FC00    671 _EP8FIFOBUF	=	0xfc00
                            ...
                            700 	.area CSEG    (CODE)
                            701 ;------------------------------------------------------------
                            702 ;Allocation info for local variables in function 'init_gpif'
                            703 ;------------------------------------------------------------
                            704 ;i                         Allocated to registers r2 
                            705 ;------------------------------------------------------------
                            706 ;	../common/init_gpif.c:35: init_gpif (void)
                            707 ;	-----------------------------------------
                            708 ;	 function init_gpif
                            709 ;	-----------------------------------------
   07B8                     710 _init_gpif:
                    0002    711 	ar2 = 0x02
                    0003    712 	ar3 = 0x03
                    ...
                    0000    717 	ar0 = 0x00
                    0001    718 	ar1 = 0x01
                            719 ;	../common/init_gpif.c:39: GPIFABORT = 0xFF;  // abort any waveforms pending
                            720 ;	genAssign
   07B8 90 E6 F5            721 	mov	dptr,#_GPIFABORT
   07BB 74 FF               722 	mov	a,#0xFF
   07BD F0                  723 	movx	@dptr,a
                            724 ;	../common/init_gpif.c:40: SYNCDELAY;
                            725 ;	genInline
   07BE 00                  726 	 nop; nop; nop; 
                            727 ;	../common/init_gpif.c:42: GPIFREADYCFG = InitData[ 0 ];
                            728 ;	genPointerGet
                            729 ;	genCodePointerGet
   07BF 90 13 42            730 	mov	dptr,#_InitData
   07C2 E4                  731 	clr	a
   07C3 93                  732 	movc	a,@a+dptr
                            733 ;	genAssign
   07C4 FA                  734 	mov	r2,a
   07C5 90 E6 F3            735 	mov	dptr,#_GPIFREADYCFG
                            736 ;	Peephole 100	removed redundant mov
   07C8 F0                  737 	movx	@dptr,a
                            738 ;	../common/init_gpif.c:43: GPIFCTLCFG = InitData[ 1 ];
                            739 ;	genPointerGet
                            740 ;	genCodePointerGet
   07C9 90 13 43            741 	mov	dptr,#(_InitData + 0x0001)
   07CC E4                  742 	clr	a
   07CD 93                  743 	movc	a,@a+dptr
                            744 ;	genAssign
   07CE FA                  745 	mov	r2,a
   07CF 90 E6 C3            746 	mov	dptr,#_GPIFCTLCFG
                            747 ;	Peephole 100	removed redundant mov
   07D2 F0                  748 	movx	@dptr,a
                            749 ;	../common/init_gpif.c:44: GPIFIDLECS = InitData[ 2 ];
                            750 ;	genPointerGet
                            751 ;	genCodePointerGet
   07D3 90 13 44            752 	mov	dptr,#(_InitData + 0x0002)
   07D6 E4                  753 	clr	a
   07D7 93                  754 	movc	a,@a+dptr
                            755 ;	genAssign
   07D8 FA                  756 	mov	r2,a
   07D9 90 E6 C1            757 	mov	dptr,#_GPIFIDLECS
                            758 ;	Peephole 100	removed redundant mov
   07DC F0                  759 	movx	@dptr,a
                            760 ;	../common/init_gpif.c:45: GPIFIDLECTL = InitData[ 3 ];
                            761 ;	genPointerGet
                            762 ;	genCodePointerGet
   07DD 90 13 45            763 	mov	dptr,#(_InitData + 0x0003)
   07E0 E4                  764 	clr	a
   07E1 93                  765 	movc	a,@a+dptr
                            766 ;	genAssign
   07E2 FA                  767 	mov	r2,a
   07E3 90 E6 C2            768 	mov	dptr,#_GPIFIDLECTL
                            769 ;	Peephole 100	removed redundant mov
   07E6 F0                  770 	movx	@dptr,a
                            771 ;	../common/init_gpif.c:47: GPIFWFSELECT = InitData[ 5 ];
                            772 ;	genPointerGet
                            773 ;	genCodePointerGet
   07E7 90 13 47            774 	mov	dptr,#(_InitData + 0x0005)
   07EA E4                  775 	clr	a
   07EB 93                  776 	movc	a,@a+dptr
                            777 ;	genAssign
   07EC FA                  778 	mov	r2,a
   07ED 90 E6 C0            779 	mov	dptr,#_GPIFWFSELECT
                            780 ;	Peephole 100	removed redundant mov
   07F0 F0                  781 	movx	@dptr,a
                            782 ;	../common/init_gpif.c:53: for (i = 0; i < 128; i++){
                            783 ;	genAssign
   07F1 7A 00               784 	mov	r2,#0x00
   07F3                     785 00101$:
                            786 ;	genCmpLt
                            787 ;	genCmp
   07F3 BA 80 00            788 	cjne	r2,#0x80,00110$
   07F6                     789 00110$:
                            790 ;	genIfxJump
                            791 ;	Peephole 108.a	removed ljmp by inverse jump logic
   07F6 50 12               792 	jnc	00104$
                            793 ;	Peephole 300	removed redundant label 00111$
                            794 ;	../common/init_gpif.c:54: GPIF_WAVE_DATA[i] = WaveData[i];
                            795 ;	genPlus
                            796 ;     genPlus aligned array
   07F8 8A 03               797 	mov	ar3,r2
   07FA 7C E4               798 	mov	r4,#(_GPIF_WAVE_DATA >> 8)
                            799 ;	genPlus
                            800 ;	Peephole 236.g	used r2 instead of ar2
   07FC EA                  801 	mov	a,r2
                            802 ;	Peephole 181	changed mov to clr
                            803 ;	genPointerGet
                            804 ;	genCodePointerGet
                            805 ;	Peephole 186.d	optimized movc sequence
   07FD 90 12 9E            806 	mov	dptr,#_WaveData
   0800 93                  807 	movc	a,@a+dptr
                            808 ;	genPointerSet
                            809 ;     genFarPointerSet
   0801 FD                  810 	mov	r5,a
   0802 8B 82               811 	mov	dpl,r3
   0804 8C 83               812 	mov	dph,r4
                            813 ;	Peephole 136	removed redundant move
   0806 F0                  814 	movx	@dptr,a
                            815 ;	../common/init_gpif.c:53: for (i = 0; i < 128; i++){
                            816 ;	genPlus
                            817 ;     genPlusIncr
   0807 0A                  818 	inc	r2
                            819 ;	Peephole 112.b	changed ljmp to sjmp
   0808 80 E9               820 	sjmp	00101$
   080A                     821 00104$:
                            822 ;	../common/init_gpif.c:58: FLOWSTATE = 0;		/* ensure it's off */
                            823 ;	genAssign
   080A 90 E6 C6            824 	mov	dptr,#_FLOWSTATE
                            825 ;	Peephole 181	changed mov to clr
   080D E4                  826 	clr	a
   080E F0                  827 	movx	@dptr,a
                            828 ;	Peephole 300	removed redundant label 00105$
   080F 22                  829 	ret
                            830 	.area CSEG    (CODE)
                            831 	.area CONST   (CODE)
